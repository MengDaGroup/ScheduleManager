package com.dayi35.qx_widget.bubble;
...
public class QBadgeView extends View implements Badge {
    ...
    private void init() {
        ...
        mBadgeTextSize = DensityUtil.dp2px(getContext(), 11);
        mBadgePadding = DensityUtil.dp2px(getContext(), 5);
        mBadgeNumber = 0;
        mBadgeGravity = Gravity.END | Gravity.TOP;
        mGravityOffsetX = DensityUtil.dp2px(getContext(), 1);
        mGravityOffsetY = DensityUtil.dp2px(getContext(), 1);
        mFinalDragDistance = DensityUtil.dp2px(getContext(), 90);
        mShowShadow = true;
        ...
        switch (event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_POINTER_DOWN:
                ...
                if (mDraggable && event.getPointerId(event.getActionIndex()) == 0
                    ...
                    mDefalutRadius = DensityUtil.dp2px(getContext(), 7);
    ...
    protected Bitmap createBadgeBitmap() {
        Bitmap bitmap = Bitmap.createBitmap((int) mBadgeBackgroundRect.width() + DensityUtil.dp2px(getContext(), 3),
                (int) mBadgeBackgroundRect.height() + DensityUtil.dp2px(getContext(), 3), Bitmap.Config.ARGB_8888);
    ...
    private void showShadowImpl(boolean showShadow) {
        int x = DensityUtil.dp2px(getContext(), 1);
        int y = DensityUtil.dp2px(getContext(), 1.5f);
        switch (mDragQuadrant) {
            case 1:
                x = DensityUtil.dp2px(getContext(), 1);
                y = DensityUtil.dp2px(getContext(), -1.5f);
                break;
            case 2:
                x = DensityUtil.dp2px(getContext(), -1);
                y = DensityUtil.dp2px(getContext(), -1.5f);
        ...
        mBadgeBackgroundPaint.setShadowLayer(showShadow ? DensityUtil.dp2px(getContext(), 2f)
                : 0, x, y, 0x33000000);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mBadgeText != null) {
            ...
            if (mDraggable && mDragging) {
                ...
                if (mDragOutOfRange = startCircleRadius < DensityUtil.dp2px(getContext(), 1.5f)) {
    ...
    public Badge stroke(int color, float width, boolean isDpValue) {
        ...
        mBackgroundBorderWidth = isDpValue ? DensityUtil.dp2px(getContext(), width) : width;
        invalidate();
        return this;
    }
    ...
    public Badge setBadgeTextSize(float size, boolean isSpValue) {
        mBadgeTextSize = isSpValue ? DensityUtil.dp2px(getContext(), size) : size;
        measureText();
        invalidate();
        return this;
    }
    ...
    public float getBadgeTextSize(boolean isSpValue) {
        return isSpValue ? DensityUtil.px2dp(getContext(), mBadgeTextSize) : mBadgeTextSize;
    }

    @Override
    public Badge setBadgePadding(float padding, boolean isDpValue) {
        mBadgePadding = isDpValue ? DensityUtil.dp2px(getContext(), padding) : padding;
        createClipLayer();
        invalidate();
        return this;
    }
    ...
    public float getBadgePadding(boolean isDpValue) {
        return isDpValue ? DensityUtil.px2dp(getContext(), mBadgePadding) : mBadgePadding;
    }
    ...
    public Badge setGravityOffset(float offsetX, float offsetY, boolean isDpValue) {
        mGravityOffsetX = isDpValue ? DensityUtil.dp2px(getContext(), offsetX) : offsetX;
        mGravityOffsetY = isDpValue ? DensityUtil.dp2px(getContext(), offsetY) : offsetY;
        invalidate();
        return this;
    }
    ...
    public float getGravityOffsetX(boolean isDpValue) {
        return isDpValue ? DensityUtil.px2dp(getContext(), mGravityOffsetX) : mGravityOffsetX;
    }

    @Override
    public float getGravityOffsetY(boolean isDpValue) {
        return isDpValue ? DensityUtil.px2dp(getContext(), mGravityOffsetY) : mGravityOffsetY;
    }
