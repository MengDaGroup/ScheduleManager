package com.dayi35.qx_widget.labelview;
...
//    private float endPosY;
    ...
    public LabelViewHelper(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.widget_lableview, defStyleAttr, 0);
        distance = attributes.getDimensionPixelSize(R.styleable.widget_lableview_widget_label_distance, dip2Px(DEFAULT_DISTANCE));
        height = attributes.getDimensionPixelSize(R.styleable.widget_lableview_widget_label_height, dip2Px(DEFAULT_HEIGHT));
        strokeWidth = attributes.getDimensionPixelSize(R.styleable.widget_lableview_widget_label_strokeWidth, dip2Px(DEFAULT_STROKE_WIDTH));
        text = attributes.getString(R.styleable.widget_lableview_widget_label_text);
        backgroundColor = attributes.getColor(R.styleable.widget_lableview_widget_label_backgroundColor, DEFAULT_BACKGROUND_COLOR);
        strokeColor = attributes.getColor(R.styleable.widget_lableview_widget_label_strokeColor, DEFAULT_STROKE_COLOR);
        textSize = attributes.getDimensionPixelSize(R.styleable.widget_lableview_widget_label_textSize, dip2Px(DEFAULT_TEXT_SIZE));
        textStyle = attributes.getInt(R.styleable.widget_lableview_widget_label_textStyle, DEFAULT_TEXT_STYLE);
        textColor = attributes.getColor(R.styleable.widget_lableview_widget_label_textColor, DEFAULT_TEXT_COLOR);
        visual = attributes.getBoolean(R.styleable.widget_lableview_widget_label_visual, true);
        orientation = attributes.getInteger(R.styleable.widget_lableview_widget_label_orientation, DEFAULT_ORIENTATION);
        attributes.recycle();
