...
import static com.dayi35.qx_widget.pop.BasePopView.ANIMATION.NONE;
    ...
    public static class Builder {
        ...
        public Builder setWidthAndHeight(int width, int height) {
            if (width == 0 && height == 0) {
                ...
                int screenH = DimensUtil.getScreenHeight();
...
//                            basePop.setAnimationStyle(R.style.style_fold_pop_animation_from_bottom);
                        ...
                        case LEFTTOP_TO_LEFTBOTTOM:
                            basePop.setAnimationStyle(R.style.widget_fold_pop_animation_from_top);
                            break;
                        case RIGHTBOTTOM_TO_LEFTTOP:
                        case RIGHTBOTTOM_TO_RIGHTTOP:
                            basePop.setAnimationStyle(R.style.widget_fold_pop_animation_from_bottom);
                            break;
                        default:
//                            basePop.setAnimationStyle(R.style.style_fold_pop_animation_from_top);
            ...
            int achorH = viewWeakReference.get().getMeasuredHeight();
            int screenW = DimensUtil.getScreenWidth();
            int screenH = DimensUtil.getScreenHeight();
            int[] achorLocation = new  int[2] ;
...
//                                basePop.setAnimationStyle(R.style.style_pop_animation_from_center);
                    ...
                    case TRANSLATE:
                        switch (_gravity) {
                            case FROM_BOTTOM:
                                basePop.setAnimationStyle(R.style.widget_translate_pop_animation_from_bottom);
                                break;
                            case FROM_TOP:
