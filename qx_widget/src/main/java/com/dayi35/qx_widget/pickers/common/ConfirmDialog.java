...
public abstract class ConfirmDialog<V extends View> extends BaseDialog<View> {
    ...
    protected int topLineColor = 0xFFF0F0F0;
    ...
    protected final View makeContentView() {
        ...
        if (mBackgroundResource != -1) {
            rootLayout.setBackgroundResource(mBackgroundResource);
        }
    ...
    protected View makeHeaderView() {
        ...
        if (mBackgroundResource != -1) {
            topButtonLayout.setBackgroundResource(mBackgroundResource);
        }
        if (!TextUtils.isEmpty(cancelText)) {
            cancelButton.setText(cancelText);
        }
        cancelButton.setTextColor(ConvertUtils.toColorStateList(cancelTextColor, cancelTextColor));
        if (cancelTextSize != 0) {
        ...
        submitButton.setTextColor(ConvertUtils.toColorStateList(submitTextColor, submitTextColor));
        if (submitTextSize != 0) {
