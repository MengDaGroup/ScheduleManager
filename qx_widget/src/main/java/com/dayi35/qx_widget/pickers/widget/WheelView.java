...
import com.dayi35.qx_widget.pickers.adapter.WheelAdapter;
import com.dayi35.qx_widget.pickers.common.InertiaTimerTask;
import com.dayi35.qx_widget.pickers.common.LineConfig;
import com.dayi35.qx_widget.pickers.common.MessageHandler;
import com.dayi35.qx_widget.pickers.common.OnItemPickedRunnable;
import com.dayi35.qx_widget.pickers.common.SmoothScrollTimerTask;
import com.dayi35.qx_widget.pickers.listeners.OnItemPickListener;
import com.dayi35.qx_widget.pickers.listeners.WheelViewGestureListener;
import com.dayi35.qx_widget.pickers.model.IPickerViewData;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        textSize = getResources().getDimensionPixelSize(R.dimen.widget_sp_16);//默认大小
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.widget_loopview, 0, 0);
            mGravity = a.getInt(R.styleable.widget_loopview_widget_view_gravity, Gravity.CENTER);
            textColorOut = a.getColor(R.styleable.widget_loopview_widget_topBottomTextColor, textColorOut);
            textColorCenter = a.getColor(R.styleable.widget_loopview_widget_centerTextColor, textColorCenter);
            dividerColor = a.getColor(R.styleable.widget_loopview_widget_lineColor, dividerColor);
            textSize = a.getDimensionPixelOffset(R.styleable.widget_loopview_widget_textSize, textSize);
            lineSpacingMultiplier = a.getFloat(R.styleable.widget_loopview_widget_lineSpacingMultiplier, lineSpacingMultiplier);
            a.recycle();//回收内存
        }
