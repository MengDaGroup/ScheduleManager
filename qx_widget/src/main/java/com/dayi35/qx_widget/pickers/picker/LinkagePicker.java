...
public class LinkagePicker extends WheelPicker {
    ...
    public void setSelectedItem(String firstText, String secondText, String thirdText) {
        ...
        List<String> firstData = provider.provideFirstDataAreaId();
        ...
        List<String> secondData = provider.provideSecondDataAreaId(selectedFirstIndex);
        for (int j = 0; j < secondData.size(); j++) {
            String st = secondData.get(j);

            if (st != null &&
                    st.contains(secondText)) {
        ...
        List<String> thirdData = provider.provideThirdDataAreaId(selectedFirstIndex, selectedSecondIndex);
...
//                    LogUtils.verbose(this, "change third data after second wheeled");
    ...
    public interface DataProvider {
        ...
        List<String> provideFirstDataAreaId();
        ...
        List<String> provideSecondDataAreaId(int firstIndex);
        ...
        List<String> provideThirdDataAreaId(int firstIndex, int secondIndex);
