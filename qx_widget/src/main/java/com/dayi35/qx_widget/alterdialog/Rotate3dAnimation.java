...
public class Rotate3dAnimation extends Animation {
    ...
    public Rotate3dAnimation (Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.widget_rotate3d_animation);

        mFromDegrees = a.getFloat(R.styleable.widget_rotate3d_animation_widget_fromDeg, 0.0f);
        mToDegrees = a.getFloat(R.styleable.widget_rotate3d_animation_widget_toDeg, 0.0f);
        mRollType = a.getInt(R.styleable.widget_rotate3d_animation_widget_rollType, ROLL_BY_X);
        Description d = parseValue(a.peekValue(R.styleable.widget_rotate3d_animation_widget_pivotX));
        mPivotXType = d.type;
        mPivotXValue = d.value;

        d = parseValue(a.peekValue(R.styleable.widget_rotate3d_animation_widget_pivotY));
        mPivotYType = d.type;
