...
public class ProgressHelper {
    ...
    public ProgressHelper(Context ctx) {
        mToSpin = true;
        mSpinSpeed = 0.75f;
        mBarWidth = ctx.getResources().getDimensionPixelSize(R.dimen.widget_dp_3) + 1;
        mBarColor = ctx.getResources().getColor(R.color.widget_color_a5dc86);
        mRimWidth = 0;
        mRimColor = 0x00000000;
        mIsInstantProgress = false;
        mProgressVal = -1;
        mCircleRadius = ctx.getResources().getDimensionPixelOffset(R.dimen.widget_dp_34);
    }
