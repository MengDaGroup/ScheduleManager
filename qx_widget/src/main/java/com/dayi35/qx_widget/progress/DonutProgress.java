package com.dayi35.qx_widget.progress;
...
public class DonutProgress extends View
{
    ...
    public DonutProgress(Context context, AttributeSet attrs, int defStyleAttr)
    {
        ...
        final TypedArray attributes = context.getTheme()
                .obtainStyledAttributes(attrs, R.styleable.widget_donut_progress, defStyleAttr, 0);
    ...
    protected void initByAttributes(TypedArray attributes)
    {
        finishedStrokeColor = attributes
                .getColor(R.styleable.widget_donut_progress_widget_donut_finished_color, default_finished_color);
        unfinishedStrokeColor = attributes
                .getColor(R.styleable.widget_donut_progress_widget_donut_unfinished_color, default_unfinished_color);
        showText = attributes.getBoolean(R.styleable.widget_donut_progress_widget_donut_show_text, true);
        attributeResourceId = attributes
                .getResourceId(R.styleable.widget_donut_progress_widget_donut_inner_drawable, 0);

        setMax(attributes.getInt(R.styleable.widget_donut_progress_widget_donut_max, default_max));
        setProgress(attributes.getFloat(R.styleable.widget_donut_progress_widget_donut_progress, 0));
        finishedStrokeWidth = attributes
                .getDimension(R.styleable.widget_donut_progress_widget_donut_finished_stroke_width, default_stroke_width);
        unfinishedStrokeWidth = attributes
                .getDimension(R.styleable.widget_donut_progress_widget_donut_unfinished_stroke_width, default_stroke_width);

        if (showText)
        {
            if (attributes.getString(R.styleable.widget_donut_progress_widget_donut_prefix_text) != null)
            {
                prefixText = attributes.getString(R.styleable.widget_donut_progress_widget_donut_prefix_text);
            }
            if (attributes.getString(R.styleable.widget_donut_progress_widget_donut_suffix_text) != null)
            {
                suffixText = attributes.getString(R.styleable.widget_donut_progress_widget_donut_suffix_text);
            }
            if (attributes.getString(R.styleable.widget_donut_progress_widget_donut_text) != null)
            {
                text = attributes.getString(R.styleable.widget_donut_progress_widget_donut_text);
            }

            textColor = attributes
                    .getColor(R.styleable.widget_donut_progress_widget_donut_text_color, default_text_color);
            textSize = attributes
                    .getDimension(R.styleable.widget_donut_progress_widget_donut_text_size, default_text_size);
            innerBottomTextSize = attributes
                    .getDimension(R.styleable.widget_donut_progress_widget_donut_inner_bottom_text_size, default_inner_bottom_text_size);
            innerBottomTextColor = attributes
                    .getColor(R.styleable.widget_donut_progress_widget_donut_inner_bottom_text_color, default_inner_bottom_text_color);
            innerBottomText = attributes
                    .getString(R.styleable.widget_donut_progress_widget_donut_inner_bottom_text);
        }
        ...
        innerBottomTextColor = attributes
                .getColor(R.styleable.widget_donut_progress_widget_donut_inner_bottom_text_color, default_inner_bottom_text_color);
        innerBottomText = attributes.getString(R.styleable.widget_donut_progress_widget_donut_inner_bottom_text);

        startingDegree = attributes
                .getInt(R.styleable.widget_donut_progress_widget_donut_circle_starting_degree, default_startingDegree);
        innerBackgroundColor = attributes
                .getColor(R.styleable.widget_donut_progress_widget_donut_background_color, default_inner_background_color);
    }
