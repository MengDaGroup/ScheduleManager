...
public class ArcProgress extends View {
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = context.getTheme().obtainStyledAttributes(attrs, R.styleable.widget_arc_progress, defStyleAttr, 0);
    ...
    protected void initByAttributes(TypedArray attributes) {
        finishedStrokeColor = attributes.getColor(R.styleable.widget_arc_progress_widget_arc_finished_color, default_finished_color);
        unfinishedStrokeColor = attributes.getColor(R.styleable.widget_arc_progress_widget_arc_unfinished_color, default_unfinished_color);
        textColor = attributes.getColor(R.styleable.widget_arc_progress_widget_arc_text_color, default_text_color);
        textSize = attributes.getDimension(R.styleable.widget_arc_progress_widget_arc_text_size, default_text_size);
        arcAngle = attributes.getFloat(R.styleable.widget_arc_progress_widget_arc_angle, default_arc_angle);
        setMax(attributes.getInt(R.styleable.widget_arc_progress_widget_arc_max, default_max));
        setProgress(attributes.getFloat(R.styleable.widget_arc_progress_widget_arc_progress, 0));
        strokeWidth = attributes.getDimension(R.styleable.widget_arc_progress_widget_arc_stroke_width, default_stroke_width);
        suffixTextSize = attributes.getDimension(R.styleable.widget_arc_progress_widget_arc_suffix_text_size, default_suffix_text_size);
        suffixText = TextUtils.isEmpty(attributes.getString(R.styleable.widget_arc_progress_widget_arc_suffix_text)) ? default_suffix_text : attributes.getString(R.styleable.widget_arc_progress_widget_arc_suffix_text);
        suffixTextPadding = attributes.getDimension(R.styleable.widget_arc_progress_widget_arc_suffix_text_padding, default_suffix_padding);
        bottomTextSize = attributes.getDimension(R.styleable.widget_arc_progress_widget_arc_bottom_text_size, default_bottom_text_size);
        bottomText = attributes.getString(R.styleable.widget_arc_progress_widget_arc_bottom_text);
    }
