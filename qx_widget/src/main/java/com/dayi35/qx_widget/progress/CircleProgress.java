...
public class CircleProgress extends View {
    ...
    public CircleProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray attributes = context.getTheme().obtainStyledAttributes(attrs, R.styleable.widget_circle_progress, defStyleAttr, 0);
    ...
    protected void initByAttributes(TypedArray attributes) {
        finishedColor = attributes.getColor(R.styleable.widget_circle_progress_widget_circle_finished_color, default_finished_color);
        unfinishedColor = attributes.getColor(R.styleable.widget_circle_progress_widget_circle_unfinished_color, default_unfinished_color);
        textColor = attributes.getColor(R.styleable.widget_circle_progress_widget_circle_text_color, default_text_color);
        textSize = attributes.getDimension(R.styleable.widget_circle_progress_widget_circle_text_size, default_text_size);

        setMax(attributes.getInt(R.styleable.widget_circle_progress_widget_circle_max, default_max));
        setProgress(attributes.getInt(R.styleable.widget_circle_progress_widget_circle_progress, 0));

        if (attributes.getString(R.styleable.widget_circle_progress_widget_circle_prefix_text) != null) {
            setPrefixText(attributes.getString(R.styleable.widget_circle_progress_widget_circle_prefix_text));
        }
        if (attributes.getString(R.styleable.widget_circle_progress_widget_circle_suffix_text) != null) {
            setSuffixText(attributes.getString(R.styleable.widget_circle_progress_widget_circle_suffix_text));
        }
    }
