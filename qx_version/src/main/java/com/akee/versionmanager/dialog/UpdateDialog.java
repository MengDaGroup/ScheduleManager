package com.akee.versionmanager.dialog;
...
import com.akee.versionmanager.listener.OnButtonClickListener;
...
import com.akee.versionmanager.utils.ScreenUtil;
...
public class UpdateDialog extends Dialog implements View.OnClickListener, OnDownloadListener {
    ...
    private void init(Context context) {
        ...
        showProgress = configuration.isShowProgress();
    ...
    private void installApk() {
        VersionApkUtil.installApk(context, VersionConstant.AUTHORITIES, apk);
    }
