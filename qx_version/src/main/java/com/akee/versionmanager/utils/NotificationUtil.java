...
public final class NotificationUtil {
    ...
    private static void afterO(NotificationManager manager) {
        ...
        if (channel == null) {
            ...
            channel = new NotificationChannel(VersionConstant.DEFAULT_CHANNEL_ID, VersionConstant.DEFAULT_CHANNEL_NAME,
...
//            channel.enableVibration(true);
    ...
    private static String getNotificationChannelId() {
        ...
        if (channel == null) {
            return VersionConstant.DEFAULT_CHANNEL_ID;
        }
