...
public class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        BaseConfig.instance().getmContext().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS)
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        ConnectivityManager manager =
                (ConnectivityManager) BaseConfig.instance().getmContext().getSystemService(Context.CONNECTIVITY_SERVICE);
...
//        }
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) BaseConfig.instance().getmContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) BaseConfig.instance().getmContext().getSystemService(Context.WIFI_SERVICE);
