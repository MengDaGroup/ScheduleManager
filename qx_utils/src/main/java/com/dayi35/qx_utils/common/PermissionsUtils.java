...
public class PermissionsUtils {
     ...
     * @param permissionsResult 回调
     */
    public void chekPermissions(Activity context,
                                String[] permissions,
                                @NonNull IPermissionsResult permissionsResult) {
     ...
     * @return
     */
    public boolean hasPermisson(Activity context, String[] permissions) {
