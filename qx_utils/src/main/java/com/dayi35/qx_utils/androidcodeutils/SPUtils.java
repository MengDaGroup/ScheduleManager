package com.dayi35.qx_utils.androidcodeutils;
 ...
 * @UpdateRemark:
 * @UpdateDate: 2020/3/14 15:23
 */
@SuppressLint("ApplySharedPref")
public final class SPUtils {

    private static final Map<String, SPUtils> widget_sp_UTILS_MAP = new HashMap<>();
    ...
    public static SPUtils getInstance(String spName, final int mode) {
        ...
        SPUtils spUtils = widget_sp_UTILS_MAP.get(spName);
        if (spUtils == null) {
            synchronized (SPUtils.class) {
                spUtils = widget_sp_UTILS_MAP.get(spName);
                if (spUtils == null) {
                    spUtils = new SPUtils(spName, mode);
                    widget_sp_UTILS_MAP.put(spName, spUtils);
                }
            }
        }
        return spUtils;
