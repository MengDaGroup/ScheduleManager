...
*/
package com.dayi35.recycle.view;
...
import com.dayi35.recycle.observer.ViewDataObserver;
import com.dayi35.recycle.utils.RefreshLogUtils;
 ...
 * </pre>
 */
public class DYRefreshView extends FrameLayout {
    ...
    public DYRefreshView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void initAttrs(AttributeSet attrs) {
        //加载attr属性
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.DYRefreshView);
        try {
            mClipToPadding = a.getBoolean(R.styleable.DYRefreshView_recyclerClipToPadding, false);
            mPadding = (int) a.getDimension(R.styleable.DYRefreshView_recyclerPadding, -1.0f);
            mPaddingTop = (int) a.getDimension(R.styleable.DYRefreshView_recyclerPaddingTop, 0.0f);
            mPaddingBottom = (int) a.getDimension(R.styleable.DYRefreshView_recyclerPaddingBottom, 0.0f);
            mPaddingLeft = (int) a.getDimension(R.styleable.DYRefreshView_recyclerPaddingLeft, 0.0f);
            mPaddingRight = (int) a.getDimension(R.styleable.DYRefreshView_recyclerPaddingRight, 0.0f);
            mScrollbarStyle = a.getInteger(R.styleable.DYRefreshView_scrollbarStyle, -1);
            mScrollbar = a.getInteger(R.styleable.DYRefreshView_scrollbars, -1);
            mEmptyId = a.getResourceId(R.styleable.DYRefreshView_layout_empty, 0);
            mProgressId = a.getResourceId(R.styleable.DYRefreshView_layout_progress, 0);
            mErrorId = a.getResourceId(R.styleable.DYRefreshView_layout_error, 0);
        } finally {
            a.recycle();
        }
    }
    ...
    private void initView() {
        ...
        //生成主View
        View v = LayoutInflater.from(getContext()).inflate(R.layout.rv_refresh_recyclerview, this);
    ...
    public void setRefreshing(final boolean isRefreshing){
        mPtrLayout.post(() -> mPtrLayout.setRefreshing(isRefreshing));
    }
