...
public class RefreshBaseLayout extends ViewGroup {
    ...
    public void addHeader(View header) {
        this.mHeader = header;
        mHeaderContent = header.findViewById(R.id.refresh_header_content);
        if (mHeaderContent == null) mHeaderContent = header;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int index = 0; index < getChildCount(); index++) {
            ...
            } else if (child == mFooter) {// 尾视图隐藏在ViewGroup所有内容视图之后
        ...
        mBottomScroll = contentHeight - getMeasuredHeight();
    }
}
